Commerce OS · 월 입고 후 가격조정 v0.5.4
...
신규 마켓 수정전송은 GOODSKEY를 창당 최대 200개씩 묶고, 같은 단계의 Shopling 창을 최대 4개까지 병렬 실행합니다.
판매가(PRICE) 배치가 전부 완료되기 전에는 옵션(OPTION) 배치를 하나도 시작하지 않습니다. 품절상품은 판매중 전환 단계가 먼저 완료되어야 합니다.
조회 결과가 500행을 넘는 묶음은 안전을 위해 자동으로 더 작은 묶음으로 분할합니다.
