Commerce OS · Shopling Stock State Sync v0.5.5

사용자 준비
- 이전 Stock State Sync 확장은 제거/비활성화하고 v0.5.5 하나만 사용합니다.
...
- `상품 수정전송` 버튼은 과거 실제 옵션전송에 성공한 가격·옵션 재송신 경로처럼 DOM 가시성 판정 없이 버튼 후보를 찾고 직접 click() 합니다.
