-- Preserve Shopling sync metadata in the legacy JSON state even for products
-- that currently have zero normalized options and must rely on historical
-- successful-upload option recovery at registration time.
