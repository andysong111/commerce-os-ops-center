...
let item=makeItem();
const snapshot=()=>({ok:true,run:started?{id:runId,month:'2026-09',policy:'MONTHLY_CONFIRMED_COST_OPTION_AWARE_GROUP_RECOVERY_V3',warnings:[]}:null,items:started?[item]:[]});
