...
test("monthly v0.5.7 batches up to 200 GOODSKEY and parallelizes only within the current phase", () => {
...
test("monthly v0.5.7 captures Shopling result counts and rows before closing the result window", () => {
...
test("v0.5.7 self-heals invalidated Commerce OS page bridge contexts", async () => {
