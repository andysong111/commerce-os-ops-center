...
test("resolved purchase stock applies stocktake, tail, corrections and current source coverage without GET writes", async () => {
  ...
  assert.deepEqual(steps, ["base", "stocktake", "tail", "corrections", "stocktake", "resolution", "validate"]);
