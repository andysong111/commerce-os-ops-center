...
const CHANNEL_MARK = "__commerceOsStockSyncBridgeHF16";

const OUTBOUND = new Map<string, string>([
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_EXTENSION_PING", "COMMERCE_OS_SHOPLING_STOCK_SYNC_EXTENSION_PING_HF16"],
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_START", "COMMERCE_OS_SHOPLING_STOCK_SYNC_START_HF16"],
]);

const INBOUND = new Map<string, string>([
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_EXTENSION_READY_HF16", "COMMERCE_OS_SHOPLING_STOCK_SYNC_EXTENSION_READY"],
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_STATUS_HF16", "COMMERCE_OS_SHOPLING_STOCK_SYNC_STATUS"],
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_PROGRESS_HF16", "COMMERCE_OS_SHOPLING_STOCK_SYNC_PROGRESS"],
  ["COMMERCE_OS_SHOPLING_STOCK_SYNC_RESULT_HF16", "COMMERCE_OS_SHOPLING_STOCK_SYNC_RESULT"],
]);
