...
import { syncLegacySeoShoplingOptionsAtomic } from "@/lib/legacySeoShoplingOptionSyncAtomic";
import {
...
const BATCH_SIZE = 20;
const TEMPORARY_DRAIN_EXPIRES_AT = Date.parse("2026-09-08T12:00:00Z");
...
export async function GET(request: Request) {
  ...
  const result = await syncLegacySeoShoplingOptionsAtomic({
    config,
    identity,
    modelNumbers,
  });
