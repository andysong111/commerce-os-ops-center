            ...
            content: [
              {
                ...
                text: [
                  ...
                  "productClass는 실제 판매물의 물체 종류를 하나로 분류한다: tool(도구/브러시/빗/기구), consumable(폼/젤/크림/오일/로션/세정제/샴푸 등 소모품), wearable(의류/장갑/안경/보호구), bag(가방/백/파우치), container(트레이/통/케이스/정리함), device(전기·기계 장치), furniture, textile(담요/매트/수건/패브릭), food, toy, accessory, part, other.",
                  "formTerms에는 제품의 물리적 형태·종류를, functionTerms에는 기능을, targetTerms에는 사용 대상·부위를 각각 짧은 명사로 넣는다.",
                  "incompatibleCategoryTerms에는 같은 분야라도 물체 종류가 달라서 절대 고르면 안 되는 카테고리 명사를 넣는다. 예: 세안브러시는 ['폼','젤','크림','오일','로션','비누','세정제'], 차량청소브러시는 ['세정제','왁스','워셔액'], 가방은 ['방석','담요','필터']처럼 제품 형태 충돌을 표현한다.",
                  "카테고리 선택에서는 사용 분야가 비슷한 것보다 productClass와 formTerms가 맞는지를 우선한다. 예를 들어 세안브러시는 클렌징폼보다 피부관리 도구/뷰티소품 쪽이 낫다.",
            ...
            content: [
              {
                ...
                text: [
                  ...
                  "모델명·옵션과 categorySearchProfile의 상품 정체성만 사용하고 효능·구성품을 추측하지 않는다.",
                  "최종 선택 우선순위는 ① productClass·formTerms의 물체 종류 일치 ② targetTerms 대상 일치 ③ functionTerms 용도 일치 ④ catalogCategoryTerms·상위분기 일치 ⑤ 문자열 유사도 순이다.",
                  "같은 분야라도 물체 종류가 다르면 선택하지 않는다. 예: tool인 세안브러시를 클렌징폼·젤·크림·오일로 선택하면 안 된다.",
                  "incompatibleCategoryTerms 또는 blockedCategoryTerms가 포함된 후보는 선택하지 않는다.",
                  "marketCategoryPaths와 catalogCategoryTerms는 단순 단어 겹침보다 우선한다.",
